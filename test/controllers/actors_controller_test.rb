...
class ActorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create actor" do
    assert_difference("Actor.count") do
      post actors_url, params: { actor: { birth_date: @actor.birth_date, email: @actor.email, name: @actor.name } }
    end
  ...
  test "should update actor" do
    patch actor_url(@actor), params: { actor: { birth_date: @actor.birth_date, email: @actor.email, name: @actor.name } }
